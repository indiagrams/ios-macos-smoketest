...
mutate_makefile() {
  ...
  # Help line: "Regenerate SmokeApp.xcodeproj from app/project.yml"
  sed -i '' 's|Regenerate SmokeApp.xcodeproj from app/project.yml|Regenerate SmokeApp.xcodeproj from app/Project.swift|g' Makefile
