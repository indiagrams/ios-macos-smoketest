...
<p align="center">
  <img src="screenshots/ios-home.png"   alt="SmokeApp template running on iOS Simulator — hammer icon, 'SmokeApp' title, and 'Rename me' instruction visible" width="260">
  &nbsp;&nbsp;
  <img src="screenshots/macos-home.png" alt="SmokeApp template running natively on macOS — same hammer icon, title, and rename instruction"                       width="500">
</p>
...
```bash
git clone https://github.com/indiagrams/ios-macos-smoketest.git /tmp/preflight \
...
gh repo create my-cool-app --template indiagrams/ios-macos-smoketest --public --clone
cd my-cool-app
```
...
The template ships with a starter app called **SmokeApp**. Time to make it yours.
...
If something isn't on this list, [open an issue](https://github.com/indiagrams/ios-macos-smoketest/issues/new) with the full `make ship` output. The maintainers care; this template exists to absorb new gotchas as they're discovered.
