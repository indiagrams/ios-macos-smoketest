...
#   README screenshots still show the original "SmokeApp" stub — which misleads
#   anyone viewing the forker's repo. This script regenerates docs/screenshots/
#   from whatever the current app is (pre-rename SmokeApp, or post-rename
...
# APP_NAME prefix (e.g. "SmokeApp" from "SmokeApp-iOS")
...
# kCGWindowOwnerName is the truncated process name (e.g. "SmokeApp", NOT
# "SmokeApp-macOS") because PRODUCT_NAME drops the platform suffix. Match by
