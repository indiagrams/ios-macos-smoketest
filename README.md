...
[![CI](https://github.com/indiagrams/ios-macos-smoketest/actions/workflows/pr.yml/badge.svg)](https://github.com/indiagrams/ios-macos-smoketest/actions/workflows/pr.yml)
...
[![Weekly canary (CI mode)](https://github.com/indiagrams/ios-macos-smoketest/actions/workflows/canary-trigger.yml/badge.svg)](https://github.com/indiagrams/ios-macos-smoketest/actions/workflows/canary-trigger.yml)
...
<p align="center">
  <img src="docs/screenshots/ios-home.png"   alt="SmokeApp template running on iOS Simulator — hammer icon, 'SmokeApp' title, and 'Rename me' instruction visible" width="260">
  &nbsp;&nbsp;
  <img src="docs/screenshots/macos-home.png" alt="SmokeApp template running natively on macOS — same hammer icon, title, and rename instruction"                       width="500">
</p>
...
- **GitHub Issues** — actionable bugs in the template (failed `make doctor`, missing prereq check, broken script): [github.com/indiagrams/ios-macos-smoketest/issues](https://github.com/indiagrams/ios-macos-smoketest/issues)
- **GitHub Discussions** — design decisions, "should the template do X", longer threads: [github.com/indiagrams/ios-macos-smoketest/discussions](https://github.com/indiagrams/ios-macos-smoketest/discussions)
