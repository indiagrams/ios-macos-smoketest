...
// is compiled into BOTH the main app target (SmokeApp-iOS) and this UI test
...
///     SmokeAppUITests/AppStoreScreenshotTests/testLightMode` when iterating.
///
...
final class AppStoreScreenshotTests: XCTestCase {
    ...
    private func launchAndCapture(appearance: XCUIDevice.Appearance, label: String) {
        ...
        // mode to Light"). SmokeAppMain reads `-UITestColorScheme` at App
